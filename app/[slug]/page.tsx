...
import { PAGE_BY_SLUG_QUERY } from '@/sanity/lib/queries/pages.ts';
import { ALL_SLUGS_QUERY } from '@/sanity/lib/queries/allSlugs';
import { SITE_SETTINGS_QUERY } from '@/sanity/lib/queries/siteSettings';
